...
# ==========================
# 5. Execução interativa (doméstico)
# ==========================
if __name__ == "__main__":
    ...
    while True:
        ...
        for role, champ in zip(roles, champs_t1):
            impact, reason = get_champion_impact(champion_impacts, league, champ)
        ...
        # Média da liga
        liga_stats_val = league_stats.get(league, 28.0)
        if isinstance(liga_stats_val, dict):
            base = liga_stats_val.get("mean_kills", 28.0)
        else:
            base = float(liga_stats_val)
